  ...
  return (
    ...
    <div className="flex flex-col min-h-screen">
      <div className="admin-fetch-user mx-8 flex-grow">
        <h2 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white mb-5 mt-5">
          Fetch User Data
        </h2>
        <input
          type="email"
            ...
            <div className="max-w-md mx-auto border border-gray-300 rounded p-4 mt-8">
              <div>
                {userData.formData.map((userDataItem) => (
                  <div key={userDataItem.id} className="grid grid-cols-3 gap-4">
                    <div>
                      <div className="font-semibold">Name</div>
                      <div>{userDataItem.name}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Age</div>
                      <div>{userDataItem.age}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Blood Group</div>
                      <div>{userDataItem.bloodgroup}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Emergency Contact</div>
                      <div>{userDataItem.emergencycontact}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Gender</div>
                      <div>{userDataItem.gender}</div>
                    </div>
                    <div className="col-span-3">
                      <div className="font-semibold">Medical Conditions</div>
                      <div>{userDataItem.medicalconditions}</div>
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div>
                  <div className="grid grid-cols-3 gap-4">
                    <div className="col-span-3">
                      ...
                      <div>{userData.inputValues[0].date}</div>
                    </div>
                    <div>
                      <div className="font-semibold">BP SYS / mmHg</div>
                      <div>{userData.inputValues[0].bpsys}</div>
                    </div>
                    <div>
                      <div className="font-semibold">BP DIA / mmHg</div>
                      <div>{userData.inputValues[0].bpdia}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Pulse Rate beats/min</div>
                      <div>{userData.inputValues[0].pulserate}</div>
                    </div>
                    <div>
                      <div className="font-semibold">
                        Total Cholesterol mg/dL
                      </div>
                      <div>{userData.inputValues[0].totalcholesterol}</div>
                    </div>
                    <div>
                      <div className="font-semibold">HDL Cholesterol mg/dL</div>
                      <div>{userData.inputValues[0].hdlcholesterol}</div>
                    </div>
                    <div>
                      <div className="font-semibold">LDL Cholesterol mg/dL</div>
                      <div>{userData.inputValues[0].ldlcholesterol}</div>
                    </div>
                    <div>
                      <div className="font-semibold">
                        Blood Glucose(Fasting) mg/dL
                      </div>
                      <div>{userData.inputValues[0].bloodglucosefasting}</div>
                    </div>
                    <div>
                      <div className="font-semibold">
                        Blood Glucose(PP) mg/dL
                      </div>
                      <div>{userData.inputValues[0].bloodglucosepp}</div>
                    </div>
                    <div>
                      <div className="font-semibold">Creatinine µmol/l</div>
                      <div>{userData.inputValues[0].creatinine}</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
          © 2024 <a href="https://flowbite.com/">VitalOrgans</a>. All Rights
          Reserved.
        </span>
